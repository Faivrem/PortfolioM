			...
			<div id="main" class="row">
				...
				<div class="grid-items preload">
						...
						<article class="item column six">
							<?php echo lien_article('premierspas')?>
								<figure><img src="http://amour-de-la-plume.com/wp-content/themes/amourdelaplume/images/background.jpg" alt=""><span class="blog-overlay"><i class="icon icon-doc"></i></span></figure>
								<div class="blog-excerpt">
									<div class="blog-excerpt-inner">
										<h5 class="meta-post">Mes premiers pas</h5>
										<h2>Le tout premier d'une longue série</h2>
									</div><!-- blog-excerpt -->
