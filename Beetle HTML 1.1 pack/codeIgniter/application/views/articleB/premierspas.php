	...
	<div id="intro-wrap">
		<div id="intro" class="preload darken" data-autoplay="5000"
			...
			<div class="intro-item"
				style="background-image: url(http://amour-de-la-plume.com/wp-content/themes/amourdelaplume/images/background.jpg);">
				<div class="photocaption">
					<h4>
						<i font-style="italic">"Ecrire c'est bien, le penser c'est mieux."</i>
					</h4>
				</div>
				<!-- photocaption -->
			</div>
		...
		<div class="row-content buffer-left buffer-right buffer-bottom">
			<div id="post-nav">
				<ul class="clear-after reset plain">
					<li id="prev-items" class="post-nav"><a href="#"><i
							class="fa fa-chevron-left"></i><span class="label">Prev</span></a></li>
					<li id="all-items" class="post-nav"><a href="#"><i
							class="icon icon-images"></i></a></li>
					<li id="next-items" class="post-nav"><a href="#"><span
