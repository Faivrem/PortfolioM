...
<html lang="en">
	...
	<head>
		...
		<title>Mes premiers pas | Maxime Faivre  </title>
		...
		<main role="main">
			<div id="intro-wrap">
				<div id="intro" class="preload darken" data-autoplay="5000" data-navigation="true" data-pagination="true" data-transition="fade">
					<div class="intro-item" style="background-image: url(http://amour-de-la-plume.com/wp-content/themes/amourdelaplume/images/background.jpg);">
						<div class="photocaption">
							<h4><i font-style="italic">"Ecrire c'est bien, le penser c'est mieux."</i></h4>
						</div><!-- photocaption -->
					</div>										
				</div><!-- intro -->				
			</div><!-- intro-wrap -->
			...
			<div id="main" class="row">
				<div class="row-content buffer-left buffer-right buffer-bottom">
					...
					<div class="post-area clear-after">
						<article role="main">
							<h5 class="meta-post"><a href="#">First</a>, <a href="#">Step</a> - <time datetime="2013-11-09">8 décembre 2016</time></h5>
							<h1>Mes premiers pas</h1>
							<p>Bonjour à tous, je me présente (si vous êtes déjà passé par la page d'accueil vous me connaissez déjà mais ça vous fera un rappel), je m'appelle Maxime et j'ai 19 ans.</p>

							<p>Je suis encore dans les études, je suis entrain de faire ma 2ème année de D.U.T. Informatique au Québec. D'ailleurs je vous écrit depuis le Canada incroyable hein. J'ai fait parti du groupe internationnal créé à Sénart l'année dernière qui consistait à regrouper les étudiants voulant partir à l'étranger. Nous etions 15 dans la classe, comment vous dire qu'on été chouchouté à fond. Cependant seulement 6 d'entre-nous sont partis, les autres ont abandonnés l'expérience en cours de chemin et ne se voyait plus partir loin de leur famille.
							 </p>
		
							
							<p>Pour ce qui est de mon aventure au Québec, j'ai fait un petit blog (<a href="https://monexperiencequebecblog.wordpress.com/" target="_blank">ici</a>) qui regroupe des articles sur mes expériences là-bas. Il y a une section blog qui vise à vous raconter et à informer quoi faire sur place. Puis une autre section qui consiste à vous donner tout pleins de conseils (gratos) pour pouvoir partir au Québec, s'y intégrer, s'organiser pour vos cours et vos examens, etc..</p>

							<p>Donc si vous avez bien compris, ce blog ci servira à poster des articles de tous les jours (et de toutes mes nuits),que cela soit sur l'informatique, sur mon humeur, sur mes astuces de tous les jours, sur "Comment faire des crêpes?",etc...<br>Quant à "Mon expérience Québec", il se concentre uniquement sur mon voyage et non sur l'informatique, et encore moins les crêpes (Bon, peut-être il y aura 1 ou 2 articles sur les pancakes mais c'est pas sûr).</p>
							<p>Sur ce, j'ai examen demain..</p>
							<p>Peace (qlf) </p>
						</article>
